...
//Ger en grund för alla API-klasser att ärva från
//Den gör att man kan analysera requests, skicka svar som JSON & hantera errors.
...
class RestAPI
{
    ...
    // helps for removing empty strings from an array
